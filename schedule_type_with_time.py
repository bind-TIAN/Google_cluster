# -*- coding: UTF-8 -*-
# 统计调度类为i时，每个在1s内、2s内、5s内，1000s内的占比，其中i可取(0~3，temp[4]:0~3)
if __name__ == '__main__':
    ...
    with open(file_name, 'r') as f:
        for line in f:
            ...
            time = int(temp[3])
            if temp[4] == '0' and time < 1000000:
                cnt_1 += 1
            if temp[4] == '0' and time < 2000000:
                cnt_2 += 1
            if temp[4] == '0' and time < 5000000:
                cnt_5 += 1
            if temp[4] == '0' and time > 1000000000:
                cnt_1000 += 1
            if temp[4] == '0':
